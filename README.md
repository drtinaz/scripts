...
3. auto_current https://github.com/drtinaz/auto_current
...
7. transfer_switch https://github.com/drtinaz/transfer_switch
   (auromatically changes the ac input source between shore/grid and generator based on the state of an external transfer switch.saves and restores current limit settings for each)
8. mp2_emulator https://github.com/drtinaz/mp2_emulator
